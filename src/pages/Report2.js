            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className={"report"} ref={ref}>
                ...
                <table>
                      ...
                      <tr>
                        <td>ยอด Sales</td>
                        <td>{sum(yearTransaction(2021), "customer_sales")}</td>
                        <td>{sum(monthTransaction(5), "customer_sales")}</td>
                        <td>{sum(weekTransaction(moment().week()-2), "customer_sales")}</td>
                        <td>{sum(weekTransaction(moment().week()-1), "customer_sales")}</td>
                      ...
                      <tr>
                        ...
                        <td>{parseInt((targetList !== undefined && targetList.ucl["2021"][4] ? targetList.ucl["2021"][4] : 0 )*4/week(2021,5))}</td>
                        <td>{sum(weekTransaction(moment().week()-1), "customer_sales")}</td>
                        <td></td>
                        <td></td>
                        <td></td>
